...
wysihtml5.dom.parse = (function() {
  ...
  function _handleAttributes(oldNode, newNode, rule) {
    ...
    var oldAttributesLength = oldAttributes.length;
    for (i=0; i<oldAttributesLength; i++) {
      var oldAttribute = oldAttributes[i];
      if (oldAttribute) {
        var oldAttributeName = oldAttribute.name;
        if (oldAttributeName !== 'style') {
          attributes[oldAttributeName] = _getAttribute(oldNode, oldAttributeName);
        }
      }
    }
...
(function(wysihtml5) {
  ...
  wysihtml5.dom.Sandbox = Base.extend(
    ...
    _createIframe: function() {
      var that   = this,
          iframeSrc = that.config.iframeSrc,
      ...
      iframe.onload = function() {
        ...
        that._onLoadIframe(iframe, !!iframeSrc);
      };
     ...
     */
    _onLoadIframe: function(iframe, usingSrc) {
